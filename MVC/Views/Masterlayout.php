        ...
        <div class="d-flex w-100 align-items-center">
            ...
            <nav class="nav">
                <ul class="d-flex list-unstyled mb-0">
                    <li class="me-2"><a href="http://websinhvien.local/Home/" class="text-white text-decoration-none">Trang chủ</a></li>
        ...
        <div class="p-3">
            ...
            <ul class="nav flex-column">
                <li class="nav-item mb-3">
                    <a href="http://websinhvien.local/manage_students" class="nav-link text-white">
                ...
                <li class="nav-item mb-3">
                    ...
                    <ul id="courseManagement" class="collapse list-unstyled ps-3 text-center">
                        <li><a href="http://websinhvien.local/manage_courses" class="text-white text-decoration-none">Danh Sách Khóa Học</a></li>
                        <li><a href="http://websinhvien.local/registration/Get_data" class="text-white text-decoration-none">Quản Lý Đăng Ký</a></li>
                    </ul>
                </li>
                <li class="nav-item mb-3">
                    ...
                    <ul id="Management2" class="collapse list-unstyled ps-3 text-center">
                        <li><a href="http://websinhvien.local/result_student/" class="text-white text-decoration-none">Xem Kết Quả</a></li>
                        <li><a href="http://websinhvien.local/result_student/view_enter_score/" class="text-white text-decoration-none">Nhập Điểm</a></li>
                    </ul>
                </li>
                <li class="nav-item mb-3">
                    ...
                    <ul id="Management3" class="collapse list-unstyled ps-3 text-center">
                        <li><a href="http://websinhvien.local/manage_tuition" class="text-white text-decoration-none">Học Phí</a></li>
                        <li><a href="http://websinhvien.local/payment_tuition" class="text-white text-decoration-none">Thanh Toán Học Phí</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a href="http://websinhvien.local/manage_accounts/" class="nav-link text-white">
